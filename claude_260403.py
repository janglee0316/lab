...
DEFAULTS = {
    ...
    "force_data": False,
    "q_list": "4",                     # ★ input length
    "num_workers": 2,                  # Lightning AI supports workers
    "tau_eff_ms": 5.0,
    "alt_km": 1500,
    "w_out": 15,
    "dop_min": 50.0,
...
def main():
    ...
    if in_notebook():
        ...
        for k, v in DEFAULTS.items():
            setattr(args, k, v)
        print("ℹ️ Notebook mode: using DEFAULTS.")
    else:
    ...
    print(f"📌 scenario={args.scenario} ablation={args.ablation}")
